...
class MoveItDemo:
    def __init__(self):
        ...
        # Remove rightover objects from a previous run
        ...
        table_pose.header.frame_id = right_reference_frame
        ...
        box1_pose.header.frame_id = right_reference_frame
        box1_pose.pose.position.x = 1
        box1_pose.pose.position.y = -0.8
        box1_pose.pose.position.z = table_ground + table_size[2] + box1_size[2] / 2.0
        box1_pose.pose.orientation.w = 1.0   
        scene.add_box(box1_id, box1_pose, box1_size)
        
        box2_pose = PoseStamped()
        box2_pose.header.frame_id = right_reference_frame
        box2_pose.pose.position.x = 1
        box2_pose.pose.position.y = -0.57
        ...
        target_pose.header.frame_id = right_reference_frame
        ...
        place_pose.header.frame_id = right_reference_frame
    ...
    def make_gripper_posture(self, joint_positions):
        ...
        t.joint_names = 'r_gripper_r_finger_joint'
    ...
    def make_gripper_translation(self, min_dist, desired, vector):
        ...
        g.direction.header.frame_id = 'right_gripper_base'
